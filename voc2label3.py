...
classes = ['head', 'helmet', 'motorman']

path1 = 'folder2/Annotations/'
path2 = 'motor_helmet_1/Annotations/'
path3 = 'motor_helmet_2/Annotations/'
path4 = 'motor_helmet_3/Annotations/'
path5 = 'motor_helmet_4/Annotations/'
path6 = 'motor_helmet_5/Annotations/'
path7 = 'motor_helmet_6/Annotations/'
path8 = 'motor_helmet_7/Annotations/'
path9 = 'motor_helmet_8/Annotations/'
path10 = 'motor_helmet_night_1/Annotations/'
...
dir_xml_to_txt(path3)
dir_xml_to_txt(path4)
dir_xml_to_txt(path5)
dir_xml_to_txt(path6)
dir_xml_to_txt(path7)
dir_xml_to_txt(path8)
dir_xml_to_txt(path9)
dir_xml_to_txt(path10)
