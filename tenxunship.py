...
def make_page():
    for p in range(1, 21):
        ...
        url = 'https://v.qq.com/x/search/?&preQid=hEtUoGMOAagpsWTLVL6TXnZOEIf5MI8NvgugwOwJPXNZ_y75wnX9Vg&q=%E9%AB%98%E7%A9%BA%E5%AE%89%E5%85%A8%E5%B8%A6&queryFrom=3&isNeedQc=false&filterValue=undefined&cur=' + str(p) + '&pageContext='
        if p == 1:
            url = 'https://v.qq.com/x/search/?&preQid=hEtUoGMOAagpsWTLVL6TXnZOEIf5MI8NvgugwOwJPXNZ_y75wnX9Vg&q=%E9%AB%98%E7%A9%BA%E5%AE%89%E5%85%A8%E5%B8%A6&queryFrom=3&isNeedQc=false&filterValue=undefined&cur=1&pageContext='
