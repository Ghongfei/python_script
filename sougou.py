...
def pullImgfFromSoGou(category, num, path):
    ...
    for i in range(num//48):
        n = i + 1
        url = 'https://pic.sogou.com/api/pic/searchList?tagQSign=&forbidqc=&query='+category+'&mode=1&st=&start='+str(n*48)+'&xml_len=48&_=1592204088907'
        ...
        for img_url in imgs_url:
            ...
            try:
                urllib.request.urlretrieve(img_url, path + '\\' + "reflective_clothing_sg2_" + str(count) + '.jpg')
