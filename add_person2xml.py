...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            xml_path = p.replace('JPEGImages/', 'Annotations/').rsplit('.')[0] + '.xml'
            ...
            with open(p.replace('JPEGImages/', 'Annotations2/').rsplit('.')[0] + '.xml', "wb") as f_out:
                f_out.write(xml)
                f_out.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='dataset/folder13/JPEGImages', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='dataset/folder13/Annotations2', help='output folder')  # output folder
